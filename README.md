...
----tokens are used to store specific data on server such as functions, values, key words or operators

- [ ] What steps can you take in your web apps to keep your data secure?
----store users as token and only allow access to those with a token. also can designate private routes for specific pages

- [ ] Describe how web servers work.
----web severs tell the code what to do with retrrieved code. can be located through url or domain and used to retrieve info or resources from written code on that server.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
----HTTP can use Read(with GET req) Update(PUT req) and Delete(DELETE req) to modify data
